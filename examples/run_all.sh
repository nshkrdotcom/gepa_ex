...
mix run examples/06_stop_conditions.exs -- "${qa_args[@]}"
mix run examples/07_merge_and_policies.exs -- "${qa_args[@]}"
mix run examples/08_optimize_anything_single_task.exs -- "${smoke_args[@]}"
mix run examples/09_optimize_anything_dataset.exs -- "${qa_args[@]}"
mix run examples/10_code_execution.exs -- "${common_args[@]}"
mix run examples/11_refiner.exs -- "${smoke_args[@]}"
mix run examples/12_tracking.exs -- "${qa_args[@]}"
